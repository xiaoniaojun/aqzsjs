...
<title>计算机学院2013届毕业生择业意向调查问卷</title>
            	...
            	<form action="" method="post" onsubmit="return Check()">
                    <div class="div_title_page_question">
                        <div style="text-align:center;">
                            <span style="line-height:1.5;"><b>计算机学院2013届毕业生择业意向调查问卷</b></span>
                        </div>
                        亲爱的<span style="color:red"><<?php echo (session('name')); ?>> [<<?php echo (session('class')); ?>>|<<?php echo (session('id')); ?>>]</span>同学：
                        <br>
                        你好！感谢你参与我们的择业意向调查。本次调查的目的在于深入了解我院毕业生的择业意向，为不断完善我院毕业生就业指导工作提供导向和决策依据。你的意见和看法对于我们了解毕业生择业意向、帮助毕业生充分就业有很大帮助，请实事求是地予以填写。本次调查只用于数据的统计分析，对于你的回答我们将严格保密，不会给你个人带来任何不利影响。
                        <br>
                        答卷方法：可根据括号内单选和多选的要求直接在相应的选项上打√。
                        <br>
                        <div style="text-align:left;">
                            <span style="line-height:1.5;">感谢你的支持与合作！&nbsp;</span>
                        </div>
                        <div style="text-align:right;">
                            <span style="line-height:1.5;">计算机学院</span>
                        </div>
                        <div style="text-align:right;">
                            <span style="line-height:1.5;">20012年11月</span>
                        </div>
                    </div>
                    <?php echo ($ti); ?>
            </div>
